...
link1_status=$(curl -Is http://mirrors.bytes.ua/iso/WindowsServer2016/14393.0.161119-1705.RS1_REFRESH_SERVER_EVAL_X64FRE_RU-RU.ISO | grep HTTP | cut -f2 -d" " | head -1)
...
if [ $link1_status = "200" ] ; then 
	sudo wget -O /mediabots/WS2012R2.ISO http://mirrors.bytes.ua/iso/WindowsServer2016/14393.0.161119-1705.RS1_REFRESH_SERVER_EVAL_X64FRE_RU-RU.ISO 
